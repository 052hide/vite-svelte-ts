<svelte:options tag="atom-button" />
...
<script lang="ts">
  ...
  const className = () => {
    const baseClassName = () =>
      "inline-flex items-center border border-transparent shadow-sm transition duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2";
